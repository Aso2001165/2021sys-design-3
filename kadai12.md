...
state カート内 {
 ...
 カート -> 注文 : 注文をクリック
 カート -> カート : 数量を変更/商品を削除
 カート -rigth-> カスタマイズ : 商品のカスタマイズ
 カスタマイズ -rigth-> カート : しない/戻る
 注文 --> カート : カートをクリック
state 注文 {
 [*] --> お届け先入力
 お届け先入力 -> 支払い方法選択 : 支払い方法選択をクリッック
 支払い方法選択 -> 入力内容確認 : 入力内容確認をクリック
 支払い方法選択 -> お届け先入力 : 修正をクリック
 入力内容確認 -> 支払い方法選択 : 修正をクリック
